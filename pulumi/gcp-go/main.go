// referred from: https://github.com/pulumi/templates/tree/master/kubernetes-gcp-go
package main
...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		gkeNetwork, err := compute.NewNetwork(ctx, "accio-network", &compute.NetworkArgs{
			AutoCreateSubnetworks: pulumi.Bool(false),
			Description:           pulumi.String("Virtual network to host the complete gke infra"),
		})
		if err != nil {
			return err
		}
		...
		gkeCluster, err := container.NewCluster(ctx, "gke-cluster", &container.ClusterArgs{
			...
			Description:      pulumi.String("Accio GKE cluster"),
