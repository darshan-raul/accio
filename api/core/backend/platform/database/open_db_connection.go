...
import (
	...
	"github.com/darshan-raul/accio/core/app/queries"
...
func OpenDBConnection() (*Queries, error) {
	...
	return &Queries{
		...
		ResourceTypeQueries: &queries.ResourceTypeQueries{DB: db},
		ProjectQueries: &queries.ProjectQueries{DB: db},
		StackQueries: &queries.StackQueries{DB: db},
		ResourceQueries: &queries.ResourceQueries{DB: db},
	}, nil
}
